...
#                                primary links), reassigned in the same
#                                critical section; RailAmendmentsSnapshot is
#                                the accessor (also the func pages.Init hands
#                                httpx.InitRailAmendments)
#   <ident>.Pm.LayoutAmendments — the manager's loaded rows (reassigned in
#                                Reload; LayoutAmendmentsSnapshot is the accessor)
#
# NOTE (independent review of ut-docs#1904, F4; extended for ut-docs#1911/#1912):
...
# BuildRailAmendments all take the manager as a parameter and read "pm.LayoutAmendments".
...
# pm.LayoutAmendments and must only ever be called with PluginMu held (or at boot, before the 30s
