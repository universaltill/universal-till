...
func seedForPages(t *testing.T, db *sql.DB) {
	...
	stmts := []string{
		...
		`CREATE TABLE payments_archive (id TEXT NOT NULL, sale_id TEXT NOT NULL, method_id TEXT NOT NULL, amount INTEGER NOT NULL, currency TEXT NOT NULL, reference TEXT, change_given INTEGER NOT NULL, paid_at TEXT NOT NULL, tip_amount INTEGER NOT NULL, masked_pan TEXT, auth_code TEXT, terminal_id TEXT, trace_id TEXT, reset_batch_id TEXT NOT NULL REFERENCES reset_batches(id));`,
