...
func TestRenderReceipt_DeviceReceiptBlock(t *testing.T) {
	...
	html, err := renderReceipt(funcs, "123", lines, payments, 1500, 0, 1500, true, 0, "", 0, nil, false, false, false, false, nil, dev, "Bakkal", receiptDesign{ShowTax: true}, "", nil, "", nil)
	if err != nil {
	...
	plain, err := renderReceipt(funcs, "123", lines, payments, 1500, 0, 1500, true, 0, "", 0, nil, false, false, false, false, nil, nil, "Bakkal", receiptDesign{ShowTax: true}, "", nil, "", nil)
	if err != nil {
		t.Fatal(err)
	}
