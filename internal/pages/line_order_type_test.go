...
func TestRenderReceipt_MixedSaleMarksLines_UniformUnchanged(t *testing.T) {
	...
	html, err := renderReceipt(funcs, "1", mixed, nil, 200, 0, 200, false, 0, "", 0, nil, false, false, false, false, nil, nil, "S", receiptDesign{}, "", nil, "", nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	html, err = renderReceipt(funcs, "2", uniform, nil, 100, 0, 100, false, 0, "", 0, nil, false, false, false, false, nil, nil, "S", receiptDesign{}, "", nil, "", nil)
	if err != nil {
		t.Fatal(err)
	}
