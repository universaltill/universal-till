...
func TestPOSRepo_TipAmount_RoundTrips(t *testing.T) {
	...
	if err := repo.InsertPayment(ctx, nil, "pay-tip", "sale-tip", "card", 420, "GBP", "auth-ref-1", 0, 50, "2026-07-28T10:00:00Z"); err != nil {
...
func TestPOSRepo_TipAmount_DefaultsToZero(t *testing.T) {
	...
	if err := repo.InsertPayment(ctx, nil, "pay-notip", "sale-notip", "cash", 250, "GBP", "", 0, 0, "2026-07-28T10:00:00Z"); err != nil {
		t.Fatalf("insert payment: %v", err)
	}
