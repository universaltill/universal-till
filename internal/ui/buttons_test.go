...
func setupTestDB(t *testing.T) *sql.DB {
	...
	stmts := []string{
		...
		// description/brand_id/is_sample_data/stock_untracked (ut-docs#2294):
		// CatalogRepo.ListItems (ButtonStore.LoadAllActive's own source)
