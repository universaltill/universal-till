...
func TestCanonicalTypesMatchTaxonomy(t *testing.T) {
	want := "page|button|popup|payment|device|integration|report|pricing|tax|import|export|hardware|background_job|scheduler|receipt_template|customer_facing|auth|notification|delivery|theme|language|layout"
