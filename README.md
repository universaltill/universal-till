...
- Open orders (every held sale on the till in one list — name, table, item count, total and how long it has been waiting; holding a recalled sale again keeps it as the same order, under the same name, rather than creating a new one)
