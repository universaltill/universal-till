...
import (
	...
	httpx "github.com/universaltill/universal-till/internal/httpx"
	common "github.com/universaltill/universal-till/internal/old_common"
	pos "github.com/universaltill/universal-till/internal/old_pos"
...
func main_old() {
	...
	// i18n
	i18n, err := config.NewI18n(filepath.Join("web", "locales"), cfg.DefaultLocale)
	if err != nil {
