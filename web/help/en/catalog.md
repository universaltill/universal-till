...
3. Use Import to load items from a CSV file, and Export to save your catalog. The file can also carry a tax rate column (and a takeaway tax rate where it differs) — Universal Till creates the matching tax codes for you automatically.
