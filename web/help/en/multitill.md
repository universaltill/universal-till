...
11. A **Tills** button appears in the menu once the shop has more than one till, on the main till and on a joined one alike. It shows this till's own name and how many tills are in the shop, and opens the Tills page. A small dot on it means something needs attention — the main till hasn't been heard from recently, or there are entries to review. A single-till shop with nothing joined yet doesn't show it at all, because there's nothing to sync yet.
