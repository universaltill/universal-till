...
Each row is one report this till has captured — sent or not — with when it was captured, what it contained (your typed note, plus tags for a voice note, screen recording, or screenshots), and its current status.
