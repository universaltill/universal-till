...
Arrange the quick-sale buttons and product grid shown on the sale screen.

## How to use it

1. Open Quick Buttons and use the search box to find an item; tap it to add it as a quick-sale button.
