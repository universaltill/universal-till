...
1. Click the 🐞 button in the top bar (managers and admins only). A small panel opens in the corner — the till underneath keeps working, so you can reproduce the problem while you describe it. If it's covering something you need to see, drag it to a different spot by its title bar.
