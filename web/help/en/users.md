...
9. The wizard also asks whether you're moving from another till system. Say no to start fresh, or choose CSV/Excel to browse to your export/backup file right there in the wizard (Loyverse and Square exports are recognised automatically, as is a speedy kasse / pepperm cashbox backup) and preview it before continuing — nothing is imported until setup finishes. If you picked a currency for your shop in an earlier step, your products are usually already in the catalog once setup completes; otherwise (or if anything about the file needs a closer look) the till takes you straight to the import screen with your file ready to go, no re-upload needed. Not ready yet? Pick "Ask me later" and an "Import from another POS" prompt appears under Settings → Data until you use it or dismiss it.
