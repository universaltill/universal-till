...
keywords: [pin, staff, roles, sign in, lock]
---
...
7. The wizard also asks whether you're moving from another till system. Say no to start fresh, or choose CSV/Excel to go straight into the catalog importer. Not ready yet? Pick "Ask me later" and a "Restore from another POS" prompt appears under Settings → Data until you use it or dismiss it.
