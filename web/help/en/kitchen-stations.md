...
1. Open **Kitchen stations** from the menu (manager only) and create a station for each place food is prepared — for example "Grill" or "Bar" — with its printer's network address or device path.
