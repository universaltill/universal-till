...
1. **Sipariş durumu**'nu açın — satış ekranındaki raftaki 🛎️ simgesinden, ya da ☰ menüden. Son satışlar en yenisi başta olacak şekilde, her biri güncel durumuyla listelenir.
...
Her satış kalıcı fiş numarasını korur (iadeler ve raporlar için) — ama müşteriye, mutfak fişine, self-servis onay ekranına ve bu listeye bunun yerine **kısa bir sipariş numarası** gösterilir; böylece söylemesi veya tezgahtan seslenmesi kolay olur. **Ayarlar → Sipariş numaraları**'ndan, her kasa kapanışından sonra 1'e sıfırlansın mı (varsayılan — çoğu modern satış noktası sisteminin yaptığıyla aynı) yoksa hiç sıfırlanmadan saymaya devam etsin mi seçin. Bu değişiklik yalnızca yeni satışları etkiler; geçmiş fişler etkilenmez.
