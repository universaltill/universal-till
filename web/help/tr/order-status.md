...
4. Her değişiklik, kimin ne zaman yaptığını durumun yanına kaydeder. Fiş numarası, İşlem geçmişindeki tam fişe götürür — başka bir kasada alındığı için burada listelenen bir sipariş hariç (aşağıdaki nota bakın): bu kasa o fişi kendi kaydında tutmadığından numara görünür ama bağlantı değildir.
