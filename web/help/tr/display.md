...
8. Ayarlar → Görünüm'de ayrıca bir pencere modu seçici (normal, büyütülmüş, tam ekran, kiosk) ve açılışta başlat anahtarı bulunur. Linux masaüstünde ikisi de gerçek: bir pencere modu seçin ya da açılışta başlatı değiştirin, kasayı bir sonraki başlatışınızda uygulanır — tam ekran/kiosk için işletim sisteminin pencere çerçevesi gizlenir, açılışta başlat ise gerçek bir otomatik başlatma girdisini ekler veya kaldırır. Raspberry Pi kiosk kasasında pencere modu seçici de gerçektir ve yeniden başlatmaya gerek kalmadan hemen uygulanır: "kiosk" moduna geçirin, özel kiosk ekranı hemen açılır; başka bir moda geçirin, hemen kapanır (Pi'nin açılışta başlat anahtarı hâlâ iskelet niteliğindedir — kutu zaten kiosk ekranını kendiliğinden açılışta başlatır). Pi cihazında kiosk ekranı tek ekrandır — "kiosk" dışına geçmek onu kapatır ve arkasında bir konsol yoktur, bu yüzden geri açmak için aynı ağda başka bir cihaza (ya da SSH'a) ihtiyacınız olur. macOS ve Windows'ta her iki ayar da hâlâ iskelet niteliğinde: kasa seçiminizi kaydeder, ama bu platform için destek çıkana kadar hiçbir şey değişmez — bu arada orada farklı bir pencere modunu etkinleştirmek için kasayı yeniden başlatın. Yanlarındaki "İşletim sistemi penceresine çık" eylemi hâlâ bir yönetici PIN'i ister ama henüz hiçbir platformda bir şey yapmaz.
