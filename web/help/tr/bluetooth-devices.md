...
3. Cihazın yanındaki **Eşleştir**'e dokunun. Kasa cihazı tek seferde eşleştirir, güvenilir yapar ve bağlar; cihaz tarama sonuçlarından eşleşmiş listesine geçer. Bundan sonra yakınlarda açıldığında kendiliğinden bağlanır — okuyucu o andan itibaren kabloyla takılı bir okuyucu gibi çalışır.
