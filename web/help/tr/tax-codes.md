...
order: 111
summary: "Vergi kodları oluşturun ve düzenleyin — salon içi oranı ve varsa farklı bir paket servis oranı — ve bunları etkinleştirin veya devre dışı bırakın."
routes: [/catalog/tax-codes]
keywords: [vergi, kdv, oran, paket servis, vergi kodu]
---

# Vergi kodları

Katalogunuzdaki her ürün, üzerinden alınan vergi oranını (ve isteğe bağlı olarak paket servis siparişleri için farklı bir oranı) belirleyen bir vergi koduna bağlıdır. Bu sayfa, bu kodların elle oluşturulup düzenlendiği yerdir — bir ürün için yalnızca mevcut bir kodu seçmenize izin veren Katalog'dan ayrı olarak.

## Nasıl kullanılır

1. **Katalog → Vergi kodları**'nı açın (yalnızca yönetici). Liste, etkin ve devre dışı tüm vergi kodlarını, salon içi oranı ve varsa paket servis oranıyla birlikte gösterir.
