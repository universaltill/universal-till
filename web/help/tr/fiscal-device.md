...
- Cihaz başarılı der ama fiş numarası vermezse, kasa da satışı reddeder — bastığına dair kanıt olmadan hiçbir şeyi kaydetmez, "onaylandı" yanıtına asla güvenmez. Yeniden ödeme almadan önce cihazı kontrol edin: kasada kaydı olmasa da para zaten alınmış olabilir; başka bir yöntemle yeniden denemek müşteriden iki kez tahsilat riski taşır. Aynı kural **iade** için de geçerlidir: cihazın başarılı dediği ama fiş vermediği bir ÖKC iadesi de aynı sebeple reddedilir.
