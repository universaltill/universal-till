...
8. Bir kullanıcı oluşturmak, birinin PIN'ini ayarlamak veya bir hesabı etkinleştirmek/devre dışı bırakmak bir yönetici veya admin rolü gerektirir. Kasiyer olarak oturum açtıysanız ve bunlardan birini denerseniz, ekran sadece reddetmez: orada bir yönetici veya adminin onaylayabileceği anında bir PIN penceresi açar — kasadaki [diğer anında yönetici onayları](/help/elevation) gibi.
