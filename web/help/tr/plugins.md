...
6. Eklentiler sayfasında bir eklentide kırmızı **Bozuk ⚠** rozeti görünüyorsa, dosyaları o kasada eksik veya okunamıyor demektir (bu, bir kasa dükkâna katıldıktan hemen sonra olabilir). Bir şey yapmanız gerekmez: kasa onu yaklaşık yarım dakika içinde mağazadan otomatik olarak yeniden yükler. O zamana kadar, vergisini o eklentinin belirlediği bir ürün o kasada satılamaz — satış ekranı hangi ürün olduğunu söyler; ürünü kaldırın ya da biraz bekleyip tekrar deneyin.
