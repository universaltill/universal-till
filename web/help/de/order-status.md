...
4. Jede Änderung zeichnet auf, wer sie wann vorgenommen hat, neben dem Status. Angezeigt wird die kurze Bestellnummer, die Ihr Kunde erhalten hat (siehe unten) — ein Tipp darauf öffnet den vollständigen Beleg im Journal, außer bei einer hier angezeigten Bestellung, weil sie an einer *anderen* Kasse aufgenommen wurde (siehe Hinweis unten), wo die Nummer zwar angezeigt, aber kein Link ist, da diese Kasse den Beleg selbst nicht besitzt.
