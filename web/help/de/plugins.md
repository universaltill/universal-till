...
9. Die Kasse prüft im Hintergrund auf Plugin-Updates — Sie müssen diese Seite dafür nicht öffnen. **Sprachpakete aktualisieren sich automatisch**, sodass eine neuere Übersetzung ohne Ihr Zutun auf Ihrer Kasse ankommt. Jede andere Art von Plugin wartet, bis Sie sie hier überprüfen: Ein grünes Abzeichen **Plugin-Updates verfügbar** erscheint in der Statusleiste unten am Bildschirm, sobald eines aussteht, mit einer Anzahl — tippen Sie darauf, um direkt zu dieser Seite zu gelangen und aus der Liste zu aktualisieren.
