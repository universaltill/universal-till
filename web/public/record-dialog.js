...
(function () {
  ...
  function open(dialog, row, opener) {
    ...
    // The open/close motion is base.html's shared popup zoom (ADR-0122 §5,
    // ut-docs#2944), which wraps .show() itself -- no per-dialog motion
    // here (#2338's own open ease was replaced by it).
